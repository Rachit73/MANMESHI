...
export const Categories = () => {
  ...
  return (
    <section className="py-2 md:py-4 px-4 md:px-6 max-w-7xl mx-auto optimize-gpu">
...
export const Gallery = () => {
  ...
  return (
    <section className="py-2 md:py-4 px-4 md:px-6 max-w-7xl mx-auto">
      <div className="text-center mb-2 md:mb-4">
        <h2 className="text-2xl md:text-4xl font-heading font-bold mb-1">Curated Showcase</h2>
        <p className="text-white/40 font-medium italic text-xs md:text-sm">Handpicked masterpieces, crafted for you.</p>
      </div>
      <div className="relative h-[250px] md:h-[450px] rounded-[16px] md:rounded-[30px] overflow-hidden shadow-2xl border border-white/10 group">
...
// 5. ABOUT SECTION
export const About = () => (
  <section className="py-2 md:py-4 px-4 md:px-6 bg-white/[0.01] optimize-gpu" id="about">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-4 md:gap-8">
      <div className="flex-1 relative w-full opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
        ...
        <img
          ...
          className="rounded-xl md:rounded-[30px] shadow-2xl relative z-10 border border-white/5 w-full object-cover aspect-[4/3] md:aspect-auto"
          alt="Our Story"
          loading="lazy"
        />
      </div>
      <div className="flex-1 space-y-2 md:space-y-3 text-center md:text-left opacity-0 animate-[fadeIn_0.5s_ease-out_forwards_0.2s]">
        <h2 className="text-2xl md:text-4xl font-heading font-bold gradient-text">Our Story</h2>
        <div className="space-y-1.5 md:space-y-2.5 text-[11px] md:text-sm text-white/60 leading-relaxed font-medium">
          <p>
        ...
        <div className="flex justify-center md:justify-start gap-4 md:gap-8 pt-2.5 border-t border-white/5">
          <div>
...
export const Hero = ({ onOpenForm }: { onOpenForm: () => void }) => (
  <section className="relative flex items-center justify-center px-4 md:px-6 pt-10 md:pt-14 pb-2 md:pb-4 overflow-hidden optimize-gpu">
    ...
    <div className="relative z-10 text-center max-w-5xl mx-auto">
      <div className="opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
        <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1 rounded-full bg-white/5 border border-white/10 text-[8px] md:text-xs font-bold text-white/60 mb-1 md:mb-1.5 backdrop-blur-2xl uppercase tracking-[0.15em] md:tracking-[0.2em]">
          <Sparkles size={10} className="text-yellow-400" />
          <span>Handcrafted Luxury Gifts</span>
        </div>
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-heading font-black tracking-tighter mb-1 md:mb-1.5 leading-[1.1] md:leading-[1.0]">
          Create Your Own <br />
          <span className="gradient-text">Custom Gift 💖</span>
        </h1>
        <p className="text-[10px] md:text-sm text-white/40 max-w-xl mx-auto mb-2 md:mb-3 font-medium leading-relaxed px-4 md:px-0">
        ...
        <div className="flex justify-center px-4 md:px-0">
          <button
            onClick={onOpenForm}
            className="w-full md:w-auto px-6 md:px-10 py-2.5 md:py-3.5 bg-gradient-to-r from-[#ff4b82] to-[#8a2be2] rounded-full font-bold text-white shadow-2xl hover:scale-105 transition-all duration-300 btn-glow text-[10px] md:text-base active:scale-95"
          >
  ...
  return (
    <section className="py-2 md:py-4 px-4 md:px-6 max-w-7xl mx-auto optimize-gpu">
      <div className="text-center mb-1.5 md:mb-2.5">
        <h2 className="text-xl md:text-3xl font-heading font-bold mb-1">Occasions to Celebrate</h2>
        <p className="text-white/40 font-medium italic text-[10px] md:text-xs">Find the perfect gift for every milestone.</p>
      </div>
      <div className="grid grid-cols-1 gap-3 md:gap-6">
        {occasions.map((occ, i) => (
          <div key={i} className={cn("flex flex-col md:flex-row items-center gap-2 md:gap-6 text-center md:text-left optimize-gpu", i % 2 !== 0 && "md:flex-row-reverse")}>
            <div
              className="flex-1 space-y-1 md:space-y-2 order-2 md:order-none opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]"
              style={{ animationDelay: `${i * 0.1}s` }}
            >
              <h2 className="text-lg md:text-3xl font-heading font-bold">{occ.title}</h2>
              <p className="text-[10px] md:text-sm text-white/40 leading-relaxed font-medium px-4 md:px-0">{occ.desc}</p>
              <div className="flex justify-center md:justify-start px-4 md:px-0">
                <button
                  onClick={onOpenForm}
                  className="w-full md:w-auto px-4 py-2 md:py-2.5 bg-gradient-to-r from-[#ff4b82] to-[#8a2be2] rounded-full font-bold text-white shadow-lg hover:scale-105 transition-all duration-300 btn-glow text-[10px] md:text-xs active:scale-95"
                >
                  Get Your Product Customised 💝
                </button>
              </div>
            ...
            <div
              className="flex-1 w-full aspect-[21/9] md:aspect-[16/9] rounded-[12px] md:rounded-[24px] overflow-hidden shadow-2xl border border-white/5 order-1 md:order-none opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]"
...
export const Testimonials = () => (
  <section className="py-2 md:py-4 px-6 bg-white/[0.01]">
    <div className="max-w-7xl mx-auto text-center">
      <h2 className="text-xl md:text-3xl font-heading font-bold mb-2 md:mb-4">Loved by Thousands</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
        {[1, 2, 3].map((_, i) => (
          <div key={i} className="glass p-3 md:p-5 rounded-[16px] md:rounded-[24px] text-left border border-white/5 hover:border-white/10 transition-colors group">
            <Quote className="text-[#ff4b82]/20 mb-1.5 md:mb-3 group-hover:text-[#ff4b82]/40 transition-colors" size={20} />
            <p className="text-[10px] md:text-sm text-white/60 mb-3 md:mb-5 italic font-medium leading-relaxed">
              "The resin frame I ordered for my sister's birthday was absolutely stunning. The attention to detail is unmatched!"
            </p>
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 md:w-8 md:h-8 bg-gradient-to-br from-[#ff4b82] to-[#8a2be2] rounded-full" />
              <div>
                <p className="font-bold text-white text-[10px] md:text-xs">Ananya Sharma</p>
                <div className="flex gap-0.5">
                  {[1, 2, 3, 4, 5].map(s => <Star key={s} size={6} className="text-yellow-500 fill-yellow-500" />)}
                </div>
              </div>
            </div>
          </div>
...
export const InstagramFeed = () => (
  <section className="py-2 md:py-4 px-6 max-w-7xl mx-auto text-center">
    <div className="flex flex-col items-center gap-1.5 md:gap-2 mb-2 md:mb-4">
      <div className="p-1.5 md:p-2 bg-gradient-to-br from-[#ff4b82] to-[#8a2be2] rounded-lg md:rounded-xl text-white shadow-xl">
        <Camera size={16} />
      </div>
      <h2 className="text-xl md:text-3xl font-heading font-bold">Follow Our Journey</h2>
      <p className="text-white/40 font-medium tracking-wide uppercase text-[7px] md:text-[9px]">@TheManmeshi_Official</p>
    </div>
    <div className="flex gap-2 md:gap-3 overflow-x-auto pb-2 md:pb-3 scrollbar-hide no-scrollbar">
      {[
        ...
        <div key={i} className="min-w-[140px] md:min-w-[200px] h-[140px] md:h-[200px] rounded-lg md:rounded-xl overflow-hidden border border-white/5 relative group cursor-pointer">
          <img
            src={url}
    ...
    <div className="flex flex-col sm:flex-row items-center justify-center gap-2 mt-3 md:mt-6">
      <button className="w-full sm:w-auto px-6 py-2.5 border border-white/10 rounded-full font-bold hover:bg-white/5 transition-colors text-[10px] md:text-xs">
        Follow on Instagram
      </button>
      <a
        href="https://wa.me/+91XXXXXXXXXX"
        target="_blank"
        rel="noopener noreferrer"
        className="w-full sm:w-auto p-2.5 bg-[#25D366] text-white rounded-full shadow-xl hover:scale-110 transition-transform duration-300 btn-glow flex items-center justify-center"
      >

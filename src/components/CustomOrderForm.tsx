...
export const About = () => (
  <section className="py-4 md:py-8 px-4 md:px-6 bg-white/[0.01] optimize-gpu" id="about">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-4 md:gap-8">
      ...
      <div className="flex-1 space-y-3 md:space-y-4 text-center md:text-left opacity-0 animate-[fadeIn_0.5s_ease-out_forwards_0.2s]">
...
export const Hero = ({ onOpenForm }: { onOpenForm: () => void }) => (
  <section className="relative min-h-[40vh] md:min-h-[65vh] flex items-center justify-center px-4 md:px-6 pt-16 md:pt-24 pb-6 md:pb-8 overflow-hidden optimize-gpu">
    ...
    <div className="relative z-10 text-center max-w-5xl mx-auto">
      <div className="opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-heading font-black tracking-tighter mb-1 md:mb-2 leading-[1.1] md:leading-[1.0]">
          Create Your Own <br />
        ...
        <div className="flex justify-center px-4 md:px-0">
          <button
            onClick={onOpenForm}
            className="w-full md:w-auto px-6 md:px-10 py-3 md:py-4 bg-gradient-to-r from-[#ff4b82] to-[#8a2be2] rounded-full font-bold text-white shadow-2xl hover:scale-105 transition-all duration-300 btn-glow text-sm md:text-lg active:scale-95"
          >
  ...
  return (
    <section className="py-4 md:py-8 px-4 md:px-6 max-w-7xl mx-auto optimize-gpu">
      <div className="text-center mb-3 md:mb-5">
        ...
        <p className="text-white/40 font-medium italic text-xs md:text-sm">Find the perfect gift for every milestone.</p>
      </div>
      <div className="grid grid-cols-1 gap-4 md:gap-8">
        {occasions.map((occ, i) => (
          <div key={i} className={cn("flex flex-col md:flex-row items-center gap-3 md:gap-6 text-center md:text-left optimize-gpu", i % 2 !== 0 && "md:flex-row-reverse")}>
            <div
              className="flex-1 space-y-2 md:space-y-3 order-2 md:order-none opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]"
              style={{ animationDelay: `${i * 0.1}s` }}
            >
              <h2 className="text-xl md:text-3xl font-heading font-bold">{occ.title}</h2>
            ...
            <div
              className="flex-1 w-full aspect-[16/9] md:aspect-[4/3] rounded-[16px] md:rounded-[24px] overflow-hidden shadow-2xl border border-white/5 order-1 md:order-none opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]"

...
export const Categories = () => {
  ...
  return (
    <section className="py-8 md:py-16 px-4 md:px-6 max-w-7xl mx-auto optimize-gpu">
      <div className="text-center mb-6 md:mb-10">
        <h2 className="text-2xl md:text-4xl font-heading font-bold mb-2">Curated Categories</h2>
...
export const Gallery = () => {
  ...
  return (
    <section className="py-8 md:py-16 px-4 md:px-6 max-w-7xl mx-auto">
      ...
      <div className="relative h-[350px] md:h-[600px] rounded-[24px] md:rounded-[40px] overflow-hidden shadow-2xl border border-white/10 group">
...
// 5. ABOUT SECTION
export const About = () => (
  <section className="py-8 md:py-16 px-4 md:px-6 bg-white/[0.01] optimize-gpu" id="about">
...
export const Hero = ({ onOpenForm }: { onOpenForm: () => void }) => (
  <section className="relative min-h-[50vh] md:min-h-[80vh] flex items-center justify-center px-4 md:px-6 pt-24 md:pt-32 pb-8 md:pb-12 overflow-hidden optimize-gpu">
    ...
    <div className="relative z-10 text-center max-w-5xl mx-auto">
      <div className="opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
        ...
        <p className="text-sm md:text-lg text-white/40 max-w-2xl mx-auto mb-6 md:mb-8 font-medium leading-relaxed px-4 md:px-0">
        ...
        <div className="flex justify-center px-4 md:px-0">
          <button
            onClick={onOpenForm}
            className="w-full md:w-auto px-8 md:px-12 py-3.5 md:py-4.5 bg-gradient-to-r from-[#ff4b82] to-[#8a2be2] rounded-full font-bold text-white shadow-2xl hover:scale-105 transition-all duration-300 btn-glow text-base md:text-lg active:scale-95"
          >
  ...
  return (
    <section className="py-8 md:py-16 px-4 md:px-6 max-w-7xl mx-auto optimize-gpu">
      ...
      <div className="grid grid-cols-1 gap-8 md:gap-16">
        {occasions.map((occ, i) => (
          <div key={i} className={cn("flex flex-col md:flex-row items-center gap-6 md:gap-12 text-center md:text-left optimize-gpu", i % 2 !== 0 && "md:flex-row-reverse")}>
            <div
            ...
            >
              ...
              <div className="flex justify-center md:justify-start px-4 md:px-0">
                <button
                  onClick={onOpenForm}
                  className="w-full md:w-auto px-6 py-3 md:py-4 bg-gradient-to-r from-[#ff4b82] to-[#8a2be2] rounded-full font-bold text-white shadow-lg hover:scale-105 transition-all duration-300 btn-glow text-sm md:text-base active:scale-95"
                >
                  Get Your Product Customised 💝
                </button>
              </div>
            ...
            <div
              className="flex-1 w-full aspect-[16/9] md:aspect-[4/3] rounded-[24px] md:rounded-[40px] overflow-hidden shadow-2xl border border-white/5 order-1 md:order-none opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]"

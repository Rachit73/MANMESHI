  ...
  return (
    <section className="py-2 md:py-4 px-4 md:px-6 max-w-7xl mx-auto optimize-gpu">
      <div className="text-center mb-2 md:mb-4">
        <h2 className="text-xl md:text-3xl font-heading font-bold mb-1">Curated Categories</h2>
        <div className="w-12 h-1 bg-gradient-to-r from-[#ff4b82] to-[#8a2be2] mx-auto" />
      </div>
...
export const Gallery = () => {
  ...
  return (
    <section className="py-2 md:py-4 px-4 md:px-6 max-w-7xl mx-auto">
      <div className="text-center mb-2 md:mb-4">
        <h2 className="text-2xl md:text-3xl font-heading font-bold mb-1">Curated Showcase</h2>
        <p className="text-white/40 font-medium italic text-[10px] md:text-xs">Handpicked masterpieces, crafted for you.</p>
      </div>
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-3 md:gap-6">
      <div className="flex-1 relative w-full opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
        ...
        <img
          ...
          className="rounded-lg md:rounded-[20px] shadow-2xl relative z-10 border border-white/5 w-full object-cover aspect-[21/9] md:aspect-auto"
          alt="Our Story"
          loading="lazy"
        />
      </div>
      <div className="flex-1 space-y-1 md:space-y-2 text-center md:text-left opacity-0 animate-[fadeIn_0.5s_ease-out_forwards_0.2s]">
        <h2 className="text-xl md:text-3xl font-heading font-bold gradient-text">Our Story</h2>
        <div className="space-y-1 md:space-y-2 text-[10px] md:text-sm text-white/60 leading-relaxed font-medium">
          <p>
        ...
        <div className="flex justify-center md:justify-start gap-4 md:gap-8 pt-2 border-t border-white/5">
          <div>
            <div className="text-lg md:text-xl font-bold text-white mb-0.5">5000+</div>
            <div className="text-[7px] md:text-[8px] font-bold uppercase tracking-widest text-white/20">Happy Gifters</div>
          </div>
          <div>
            <div className="text-lg md:text-xl font-bold text-white mb-0.5">100%</div>
            <div className="text-[7px] md:text-[8px] font-bold uppercase tracking-widest text-white/20">Personalised</div>
          </div>
        </div>
      </div>
    </div>
...
export const Hero = ({ onOpenForm }: { onOpenForm: () => void }) => (
  <section className="relative flex items-center justify-center px-4 md:px-6 pt-12 md:pt-16 pb-4 md:pb-6 overflow-hidden optimize-gpu">
    ...
    <div className="relative z-10 text-center max-w-5xl mx-auto">
      <div className="opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
        <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1 rounded-full bg-white/5 border border-white/10 text-[9px] md:text-xs font-bold text-white/60 mb-1 md:mb-2 backdrop-blur-2xl uppercase tracking-[0.15em] md:tracking-[0.2em]">
          <Sparkles size={10} className="text-yellow-400" />
          <span>Handcrafted Luxury Gifts</span>
        </div>
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-heading font-black tracking-tighter mb-1 md:mb-2 leading-[1.1] md:leading-[1.0]">
          Create Your Own <br />
          <span className="gradient-text">Custom Gift 💖</span>
        </h1>
        <p className="text-xs md:text-sm text-white/40 max-w-xl mx-auto mb-3 md:mb-4 font-medium leading-relaxed px-4 md:px-0">
        ...
        <div className="flex justify-center px-4 md:px-0">
          <button
            onClick={onOpenForm}
            className="w-full md:w-auto px-6 md:px-8 py-2.5 md:py-3.5 bg-gradient-to-r from-[#ff4b82] to-[#8a2be2] rounded-full font-bold text-white shadow-2xl hover:scale-105 transition-all duration-300 btn-glow text-sm md:text-base active:scale-95"
          >
      ...
      <div className="grid grid-cols-1 gap-3 md:gap-6">
        {occasions.map((occ, i) => (
          <div key={i} className={cn("flex flex-col md:flex-row items-center gap-2 md:gap-6 text-center md:text-left optimize-gpu", i % 2 !== 0 && "md:flex-row-reverse")}>
            ...
            <div
              className="flex-1 w-full aspect-[21/9] rounded-[12px] md:rounded-[24px] overflow-hidden shadow-2xl border border-white/5 order-1 md:order-none opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]"

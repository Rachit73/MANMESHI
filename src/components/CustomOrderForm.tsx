  ...
  <section className="relative min-h-[60vh] md:min-h-[85vh] flex items-center justify-center px-4 md:px-6 pt-24 md:pt-32 pb-12 md:pb-20 overflow-hidden optimize-gpu">
    ...
    <div className="relative z-10 text-center max-w-5xl mx-auto">
      <div className="opacity-0 animate-[fadeIn_0.5s_ease-out_forwards]">
        ...
        <h1 className="text-5xl sm:text-6xl md:text-8xl font-heading font-black tracking-tighter mb-3 md:mb-4 leading-[1.1] md:leading-[0.95]">
          Create Your Own <br />
          <span className="gradient-text">Custom Gift 💖</span>
        </h1>
        <p className="text-base md:text-xl text-white/40 max-w-2xl mx-auto mb-6 md:mb-8 font-medium leading-relaxed px-4 md:px-0">
...
export const InstagramFeed = () => (
  <section className="py-12 md:py-20 px-6 max-w-7xl mx-auto text-center">
    ...
    <div className="flex gap-4 md:gap-6 overflow-x-auto pb-6 md:pb-10 scrollbar-hide no-scrollbar">
      {[

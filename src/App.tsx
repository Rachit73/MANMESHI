...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#030303] selection:bg-[#ff4b82]/30 text-white font-body">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-[100] bg-black border-b border-white/5 px-4 md:px-12 py-2 md:py-3 flex items-center justify-between">
        <div className="flex items-center gap-2 md:gap-3">
          <img
            src="/logo.png"
            alt="Logo"
            className="h-10 md:h-16 w-auto mix-blend-screen"
          />
          <div className="text-lg md:text-2xl font-heading font-black tracking-tighter gradient-text leading-tight">
            THE MANMESHI
          </div>
        </div>
      ...
      <main className="space-y-1 md:space-y-2">
